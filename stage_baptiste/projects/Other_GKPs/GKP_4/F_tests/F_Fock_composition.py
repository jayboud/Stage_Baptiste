...
# fig,ax = plt.subplots()
# ax.bar(np.arange(0, dim), np.real(f_coeffs))
# ax.bar(np.arange(0, dim)+1, np.imag(np.exp(1j*pi/4)*f_coeffs))
# plt.savefig("/Users/jeremie/Desktop/Stage_Baptiste/stage_baptiste/projects/Other_GKPs/GKP_4/F_tests/figs/fock_comp_final")
